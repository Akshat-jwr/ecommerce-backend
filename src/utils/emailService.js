        ...
        const mailOptions = {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
                    ...
                    <p>Best regards,<br>Om Creations Team</p>
                </div>
            `
        };
        ...
        const mailOptions = {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
                    ...
                    <p>Thank you for joining Om Creations. We're excited to have you as part of our community!</p>
                    <p>You can now browse our catalog of customized gifts and place orders.</p>
                    <p>If you have any questions or need assistance, feel free to contact our support team by replying to this email.</p>
                    <p>Best regards,<br>Om Creations Team</p>
                </div>
            `
        };
